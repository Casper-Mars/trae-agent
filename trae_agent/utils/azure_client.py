...
class AzureClient(BaseLLMClient):
    ...
    def parse_messages(self, messages: list[LLMMessage]) -> list[ChatCompletionMessageParam]:
        ...
        for msg in messages:
            if msg.tool_call:
                azure_messages.append(ChatCompletionFunctionMessageParam(
                    content=json.dumps({
                ...
                azure_messages.append(ChatCompletionToolMessageParam(
                    content=result,
                    role="tool",
                ...
                azure_messages.append(ChatCompletionSystemMessageParam(
                    content=msg.content,
                    role="system"
                ))
            elif msg.role == "user":
                ...
                azure_messages.append(ChatCompletionUserMessageParam(
                    content=msg.content,
                    role="user"
                ))
                ...
                azure_messages.append(ChatCompletionAssistantMessageParam(
                    content=msg.content,
                    role="assistant"
                ))
            else:
